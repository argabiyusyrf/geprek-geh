...
<div class="auth-page">
    <div class="auth-shell">
        ...
        <div class="auth-panel">
            <a href="/geprek-geh/auth/recovery" class="auth-back" aria-label="Kembali ke pemulihan">
            ...
            <div class="auth-card">
                <div class="auth-card-core">
                    ...
                    <form method="POST" action="/geprek-geh/auth/recovery/ubah" id="recoveryChangeForm" novalidate>
                        <?= csrf_field() ?>
