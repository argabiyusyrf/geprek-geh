...
?>
<?php if (Auth::check()): ?>
    <form method="POST" action="/geprek-geh/wishlist/<?= $pid ?>/toggle" class="wish-form wish-btn-overlay">
        <?= csrf_field() ?>
...
<?php else: ?>
    <a href="/geprek-geh/auth/login" class="product-wish wish-btn-overlay" title="Masuk untuk menyimpan ke daftar keinginan" aria-label="Masuk untuk menyimpan ke daftar keinginan">
