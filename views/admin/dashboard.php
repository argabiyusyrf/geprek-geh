...
<div class="stock-alert">
    <div class="stock-alert-head">
        <span class="stock-alert-ic stock-alert-ic--ok">
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"/><path d="M22 4L12 14.01l-3-3"/></svg>
        </span>
        <div class="stock-alert-txt">
            <strong>Semua stok aman</strong>
            <small>Stok produk di atas ambang batas <?= (int) $threshold ?> unit.</small>
        </div>
        <div class="stock-alert-actions">
            <a href="/admin/stock" class="btn btn-outline btn-xs">Kelola Stok</a>
        </div>
    </div>
</div>
<?php endif; ?>
